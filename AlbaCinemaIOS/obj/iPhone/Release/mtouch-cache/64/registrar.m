...
void xamarin_create_classes () {
	...
	__xamarin_class_map [19].handle = objc_getClass ("UINavigationController");
	...
	__xamarin_class_map [23].handle = objc_getClass ("UIToolbar");
	__xamarin_class_map [24].handle = objc_getClass ("UIFont");
	__xamarin_class_map [25].handle = objc_getClass ("UIImage");
	__xamarin_class_map [26].handle = objc_getClass ("UINavigationBar");
	...
	__xamarin_class_map [42].handle = objc_getClass ("UITableViewRowAction");
